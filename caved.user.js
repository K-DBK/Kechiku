// ==UserScript==
// @name         케이브덕 커스텀 매니저 v6 (사이드 패널 디자인)
// @namespace    http://tampermonkey.net/
// @version      6.0
// @description  케이브덕 메인페이지 UI 커스텀, 우측 사이드 패널 제어, 텍스트 기반 성향 필터링, 표지 마스킹
// @match        *://caveduck.io/*
// @grant        GM_setValue
// @grant        GM_getValue
// @grant        GM_addStyle
...
(function () {
    ...
    /* =========================================================
       1. 설정 및 상태 관리 (공식 크리에이터 숨기기 제거)
       ========================================================= */
    const CONFIG_KEY = 'caveduck_advanced_config_v6';
    const defaultConfig = {
        hideBanner: false,
        hidePopular: false,
        hideWorld: false,
    ...
    function createUI() {
        ...
        // 값 초기화 및 리스너 등록
        const fields = ['hideBanner', 'hidePopular', 'hideWorld', 'genderFilter', 'maskGender', 'blockedTags', 'blockedCreators', 'favoriteCreators'];
